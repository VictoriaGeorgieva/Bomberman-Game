...
(function() {
  ...
  CanvasInput = (function() {
    ...
    function CanvasInput(options) {
      ...
      x = options.x || 0;
      y = options.y || 0;
      this.typeToCalculateSpace = options.typeToCalculateSpace || 'default';
    ...
    CanvasInput.prototype.refresh = function() {
      ...
      var valueToAdd = 0;
      if(this.typeToCalculateSpace == 'MessageBox'){
        valueToAdd = this.ctx.measureText(text.substring(0, this.cursorPos)).width;
      }

      this.ctx.fillText(text, this.xPos + offset + valueToAdd, this.yPos + this.height / 2 + this.fontSize / 2);
      if (this.cursorOn) {
        this.ctx.fillStyle = this.defaultFontColor;
